<template>
  <div class="skill">
    <div class="container">
      ...
      <div class="s_wrapper">
        <div class="progress-bar" :key="index" v-for="item,index in skill">
